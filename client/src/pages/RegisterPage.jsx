    ...
    <div className="min-h-[85vh] flex justify-center items-center px-4 py-12">
      ...
      >
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-extrabold text-zinc-900 dark:text-white tracking-tight">Create an account</h2>
        </div>
        ...
        <p className="mt-10 text-center text-sm font-medium text-violet-600 dark:text-violet-400">
          <Link to="/login" className="hover:text-violet-700 dark:hover:text-violet-300 transition-colors">
