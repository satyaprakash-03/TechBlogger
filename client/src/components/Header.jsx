          ...
          {userInfo ? (
            <>
              ...
              <div ref={dropRef} className="relative">
                ...
                >
                  <img src={userInfo.avatar} alt="avatar" className="w-7 h-7 rounded-full object-cover ring-2 ring-violet-500/30" />
                ...
                {userInfo ? (
                  <>
                    <div className="flex items-center gap-3 px-4 py-3 bg-zinc-100 dark:bg-zinc-800/60 rounded-xl">
                      <img src={userInfo.avatar} alt="" className="w-9 h-9 rounded-full object-cover ring-2 ring-violet-500/30" />
                      <div>
